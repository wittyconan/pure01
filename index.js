...
const UUID = process.env.UUID || 'a203ec9b-681c-4022-b0ca-e4c989195326'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || '';        // 哪吒v1填写形式: nz.abc.com:8008  哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '';            // 使用哪吒v1请留空，哪吒v0需填写
const NEZHA_KEY = process.env.NEZHA_KEY || '';              // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'net3.982694.xyz';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiYzE1MjZjNzg5Mjc3N2QwMDQzMTNhYmIyODIyMTM2YTIiLCJ0IjoiYTM3MThlNDAtZWQyNC00OTQ3LTljMmMtOTBlNTczYzI1MTY0IiwicyI6Ill6Y3pPV0V5WXpNdFpqazJaaTAwWTJReUxUbGxZVGd0TjJSak5EbGxNemN5TW1WbCJ9';              // 固定隧道密钥json或token,留空即启用临时隧道,json获取地址：https://json.zone.id
...
const HY2_PORT = process.env.HY2_PORT || '2029';                // hy2端口，支持多端口的可以填写，否则留空
const REALITY_PORT = process.env.REALITY_PORT || '2029';        // reality端口，支持多端口的可以填写，否则留空
